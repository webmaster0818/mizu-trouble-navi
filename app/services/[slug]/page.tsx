    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 border-l-4 border-primary pl-4">こんな症状はありませんか？</h2>
        ...
        {/* 原因 */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 border-l-4 border-primary pl-4">主な原因</h2>
        ...
        {/* 料金相場 */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 border-l-4 border-accent pl-4">{service.name}の料金相場</h2>
        ...
        {/* 応急処置 */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 border-l-4 border-success pl-4">応急処置の方法</h2>
          <div className="space-y-4">
        ...
        {/* 業者比較表 */}
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 border-l-4 border-primary pl-4">{service.name}対応業者5社比較</h2>
          <div className="overflow-x-auto">
            <table className="w-full text-sm border-collapse border border-gray-200">
              <thead>
                <tr className="bg-primary text-white">
        ...
        <section className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-4">その他のサービス</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {services.filter(s => s.slug !== slug).map((s) => (
              <Link key={s.slug} href={`/services/${s.slug}/`} className="p-3 bg-gray-50 rounded-lg border hover:border-primary transition text-center text-sm font-bold">
                {s.shortName}
              </Link>
            ))}
          </div>
