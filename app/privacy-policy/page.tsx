    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none text-sm leading-relaxed text-gray-700 space-y-6">
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8">1. 個人情報の収集について</h2>
          <p>当サイトでは、お問い合わせの際にお名前、メールアドレス等の個人情報をご提供いただく場合があります。</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">2. 個人情報の利用目的</h2>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8">3. 個人情報の第三者提供</h2>
          <p>法令に基づく場合を除き、個人情報を第三者に提供することはありません。</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">4. アクセス解析ツールについて</h2>
          ...
          <h2 className="text-xl font-bold text-gray-900 mt-8">5. 広告について</h2>
          <p>当サイトでは、第三者配信の広告サービスを利用しています。広告配信事業者は、ユーザーの興味に応じた広告を表示するためにCookieを使用することがあります。</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">6. アフィリエイトプログラムについて</h2>
          <p>当サイトは、各種アフィリエイトプログラムに参加しています。当サイトを経由して商品・サービスを購入された場合、当サイトに紹介料が支払われることがあります。</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">7. 免責事項</h2>
          <p>当サイトに掲載されている情報の正確性には万全を期していますが、利用者が当サイトの情報を用いて行う一切の行為について、当サイトは責任を負いません。</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">8. 著作権について</h2>
          <p>当サイトに掲載されている文章・画像等の著作物は、著作権法により保護されています。無断転載・複製はお断りいたします。</p>

          <h2 className="text-xl font-bold text-gray-900 mt-8">9. プライバシーポリシーの変更</h2>
